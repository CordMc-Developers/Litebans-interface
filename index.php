...
<div class="container">
    <div class="jumbotron">
        <div style="text-align:center;">
            <div class="punish" >
                ...
                <p style="text-align:center;">Welcome To The VinciMc Punishment List!</p>
                <p style="text-align:center;"><u>Network Links</p>
                <p style="text-align:center;"><u>Forums</p>
                <a class="report" href="https://vincimc.com/forum"><i class="fa fa-list" aria-hidden="true"></i> Forums</a>
                <p style="text-align:center;"></p>
                <p style="text-align:center;"><u>Store</p>                 
                <a class="report" href="https://store.vincimc.com"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Store</a>
    ...
    <div class="jumbotron">
                ...
                <a class="report" href="https://vincimc.com/forum"><i class="fa fa-graduation-cap" aria-hidden="true"></i> REPORT</a>
            </div>
            <h2></h2>
        </div>
